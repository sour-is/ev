...
type ComplexityRoot struct {
	...
	Query struct {
		Events             func(childComplexity int, streamID string, paging *gql_ev.PageInput) int
...
type QueryResolver interface {
	Events(ctx context.Context, streamID string, paging *gql_ev.PageInput) (*gql_ev.Connection, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.events":
		...
		return e.complexity.Query.Events(childComplexity, args["streamID"].(string), args["paging"].(*gql_ev.PageInput)), true
...
var sources = []*ast.Source{
	{Name: "../../../api/gql_ev/schema.graphqls", Input: `extend type Query {
...
func (ec *executionContext) _Event_payload(ctx context.Context, field graphql.CollectedField, obj *gql_ev.Event) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Event_tags(ctx context.Context, field graphql.CollectedField, obj *gql_ev.Event) (ret graphql.Marshaler) {
...
func (ec *executionContext) fieldContext_Event_meta(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "id":
				return ec.fieldContext_Meta_id(ctx, field)
			case "streamID":
...
func (ec *executionContext) _Meta_id(ctx context.Context, field graphql.CollectedField, obj *event.Meta) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Meta_id(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Meta_id(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Meta",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Events(rctx, fc.Args["streamID"].(string), fc.Args["paging"].(*gql_ev.PageInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
